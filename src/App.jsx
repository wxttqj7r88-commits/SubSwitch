...
- { box-sizing: border-box; margin: 0; padding: 0; }
  .ss-wrap { min-height: 100vh; background: #f5f7fa; font-family: ‘Noto Sans JP’,‘Hiragino Sans’,sans-serif; color: #1a2340; padding-bottom: 60px; }
  .ss-header { background: #1a2e5a; padding: 22px 20px 18px; text-align: center; position: sticky; top: 0; z-index: 20; box-shadow: 0 2px 12px rgba(26,46,90,0.15); }
  .ss-header-sub { font-size: 10px; letter-spacing: .18em; color: #a8c0e8; margin-bottom: 4px; text-transform: uppercase; }
  .ss-header-title { font-size: 18px; font-weight: 700; color: #fff; }
  .ss-back { display: flex; align-items: center; gap: 6px; color: #4a6090; font-size: 13px; cursor: pointer; background: none; border: none; font-family: inherit; padding: 16px 16px 0; font-weight: 500; }
  .ss-card { margin: 10px 14px 0; background: #fff; border: 1px solid #e2e8f0; border-radius: 16px; padding: 18px 16px 44px; cursor: pointer; transition: border-color .2s, transform .15s, box-shadow .2s; position: relative; box-shadow: 0 2px 8px rgba(26,46,90,0.06); }
  .ss-card:active { border-color: #1a2e5a; transform: scale(.985); box-shadow: 0 4px 16px rgba(26,46,90,0.12); }
  .ss-card-icon { font-size: 20px; color: #1a2e5a; margin-bottom: 8px; }
  .ss-card-top { display: flex; align-items: flex-start; justify-content: space-between; }
  .ss-card-title { font-size: 14px; font-weight: 700; color: #1a2340; line-height: 1.5; flex: 1; padding-right: 8px; }
  .ss-card-tag { font-size: 10px; padding: 3px 10px; border-radius: 20px; background: #eef2fb; color: #1a2e5a; white-space: nowrap; font-weight: 600; }
  .ss-card-desc { font-size: 12px; color: #6b7a99; line-height: 1.8; margin-top: 6px; }
  .ss-card-arrow { position: absolute; right: 16px; bottom: 16px; color: #c8d4e8; font-size: 16px; }
  .ss-panel { margin: 14px 14px 0; background: #fff; border: 1px solid #e2e8f0; border-radius: 16px; padding: 24px 20px; box-shadow: 0 2px 8px rgba(26,46,90,0.06); }
  .ss-panel-icon { font-size: 28px; color: #1a2e5a; margin-bottom: 10px; }
  .ss-panel-title { font-size: 18px; font-weight: 700; color: #1a2340; margin-bottom: 8px; }
  .ss-panel-desc { font-size: 13px; color: #6b7a99; line-height: 1.9; margin-bottom: 18px; white-space: pre-line; }
  .ss-btn { width: 100%; border: none; border-radius: 12px; padding: 15px; font-size: 14px; font-weight: 700; cursor: pointer; font-family: inherit; transition: all .18s; margin-bottom: 10px; display: block; text-align: center; text-decoration: none; }
  .ss-btn-gold { background: #1a2e5a; color: #fff; box-shadow: 0 4px 12px rgba(26,46,90,0.25); }
  .ss-btn-gold:active { background: #243d76; transform: scale(.98); }
  .ss-btn-ghost { background: #fff; color: #4a6090; border: 1.5px solid #c8d4e8; }
  .ss-btn-ghost:active { border-color: #1a2e5a; color: #1a2e5a; }
  .ss-btn-line { background: #06b96a; color: #fff; display: flex; align-items: center; justify-content: center; gap: 8px; box-shadow: 0 4px 12px rgba(6,185,106,0.25); }
  .ss-btn-line:active { background: #05a85e; }
  .ss-input { width: 100%; background: #f8fafc; border: 1.5px solid #dde4f0; border-radius: 10px; color: #1a2340; font-family: inherit; font-size: 14px; padding: 12px 14px; resize: vertical; outline: none; margin-top: 8px; transition: border-color .2s; line-height: 1.7; }
  .ss-input:focus { border-color: #1a2e5a; background: #fff; }
  textarea.ss-input { min-height: 90px; }
  .ss-label { font-size: 13px; color: #1a2340; margin-top: 16px; margin-bottom: 2px; font-weight: 600; }
  .ss-hint { font-size: 11px; color: #8a9bbf; margin-top: 4px; line-height: 1.6; }
  .ss-progress { height: 4px; background: #e2e8f0; border-radius: 2px; margin-bottom: 20px; overflow: hidden; }
  .ss-progress-fill { height: 100%; background: linear-gradient(90deg,#1a2e5a,#3a5fa0); transition: width .4s; }
  .ss-dots { display: flex; gap: 5px; flex-wrap: wrap; margin-bottom: 18px; }
  .ss-dot { width: 7px; height: 7px; border-radius: 50%; background: #dde4f0; cursor: pointer; transition: background .2s; }
  .ss-dot.ans { background: #1a2e5a; }
  .ss-dot.cur { background: #3a5fa0; box-shadow: 0 0 5px rgba(58,95,160,.5); }
  .ss-badge { display: inline-block; background: #eef2fb; border-radius: 20px; padding: 4px 14px; font-size: 11px; color: #1a2e5a; margin-bottom: 14px; font-weight: 600; }
  .ss-point-btn { background: #f0f4ff; border: 1.5px solid #c8d4e8; border-radius: 8px; color: #1a2e5a; font-size: 11px; padding: 6px 14px; cursor: pointer; font-family: inherit; margin-top: 12px; display: flex; align-items: center; gap: 5px; font-weight: 600; }
  .ss-point-box { margin-top: 8px; background: #f0f4ff; border: 1.5px solid #c8d4e8; border-radius: 10px; padding: 14px 16px; font-size: 12px; color: #1a2e5a; line-height: 1.9; }
  .ss-sub-card { margin-bottom: 10px; background: #fff; border: 1px solid #e2e8f0; border-radius: 14px; padding: 16px; cursor: pointer; transition: all .18s; box-shadow: 0 2px 6px rgba(26,46,90,0.05); }
  .ss-sub-card:active { border-color: #1a2e5a; transform: scale(.985); }
  .ss-sub-title { font-size: 14px; font-weight: 700; color: #1a2340; margin-bottom: 4px; }
  .ss-sub-desc { font-size: 12px; color: #6b7a99; line-height: 1.7; white-space: pre-line; }
  `;
